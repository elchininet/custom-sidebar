...
This will log any event registered by `Custom Sidebar` inside Logbook using `person` as domain and using the entity relative to the user that triggered the event.
