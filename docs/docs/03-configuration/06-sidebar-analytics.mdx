...
import SimpleExample from '@site/docs/_partials/03-configuration/06-sidebar-analytics/_simple-example.mdx';
import SidebarItemClickedExample from '@site/docs/_partials/03-configuration/06-sidebar-analytics/_sidebar-item-clicked.mdx';
import PanelVisitedExample from '@site/docs/_partials/03-configuration/06-sidebar-analytics/_panel-visited.mdx';
