...
4. Check that you have placed your `custom-sidebar-config.yaml` or `custom-sidebar-config.json` (depending on the configuration format that you have chosen) inside the `<config directory>/www/` directory.
