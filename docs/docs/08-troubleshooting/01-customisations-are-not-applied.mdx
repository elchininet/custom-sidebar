...
3. Check that you have added the [extra_module_url] in the `frontend` entry on your configuration and using the provided paths. (Note: Using lovelace resources in the GUI is not the same!)
