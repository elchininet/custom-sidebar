...
3. Check that you have added the [extra_module_url] in the `frontend` entry on your configuration and using the provided paths as instructed in [the Installation section](../installation).
4. Check that you have placed your `custom-sidebar-config.yaml` inside the `<config directory>/www/` directory.
