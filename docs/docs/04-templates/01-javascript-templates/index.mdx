...
| [Localize methods]           | Methods related to localization/translations using the user locale settings of the user profile |
...
[Localize methods]: ./Methods%20available/03-localize-methods.mdx
[Dialogs and toasts methods]: ./Methods%20available/04-dialogs-and-toasts-methods.mdx
[REST API methods]: ./Methods%20available/05-rest-api-methods.mdx
