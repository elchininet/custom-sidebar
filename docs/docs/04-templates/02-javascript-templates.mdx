...
import OnclickWithJavaScriptCodeExample from '@site/docs/_partials/04-templates/02-javascript-templates/_on-click-with-javascript-code.mdx';

import OpenAlertDialogCode from '@site/docs/_partials/04-templates/02-javascript-templates/dialogs/_open-alert-dialog.mdx';
import OpenConfirmDialogCode from '@site/docs/_partials/04-templates/02-javascript-templates/dialogs/_open-confirm-dialog.mdx';
import OpenMoreInfoDialogCode from '@site/docs/_partials/04-templates/02-javascript-templates/dialogs/_open-more-info-dialog.mdx';
import OpenRestartDialog from '@site/docs/_partials/04-templates/02-javascript-templates/dialogs/_open-restart-dialog.mdx';
...
<OpenConfirmDialogCode />

---

#### openMoreInfoDialog

This method will open a more info dialog of the specified entity. It rquires an `entityId` parameter which is the entity that will be open in the more info dialog.

<OpenMoreInfoDialogCode />
...
Take into account that only admins are able to restart `Home Assistant`.
...
<OnclickWithJavaScriptCodeExample />
