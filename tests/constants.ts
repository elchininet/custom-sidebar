...
export const SELECTORS = {
    ...
    PROFILE_EDIT_BUTTON: '.content > ha-card ha-pick-dashboard-row + ha-row-item > ha-button',
    PROFILE_HIDE_SIDEBAR: '.content > ha-card ha-force-narrow-row ha-row-item > ha-switch',
    NOTIFICATIONS: 'ha-list-item-button.notifications',
    ...
    ITEM_TEXT: '.item-text',
    PROFILE: 'ha-list-item-button.user',
    ...
    TOOLTIP: 'ha-sidebar ha-tooltip',
    POPUP: 'wa-popup div.body',
    HA_ICON: 'ha-icon',
